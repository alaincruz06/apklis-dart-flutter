...
/** ApklisDirectPaymentCheckerPlugin */
class ApklisDirectPaymentCheckerPlugin : FlutterPlugin, MethodCallHandler {
    ...
    override fun onAttachedToEngine(@NonNull flutterPluginBinding: FlutterPlugin.FlutterPluginBinding) {
        channel = MethodChannel(flutterPluginBinding.binaryMessenger, "apklis_direct_payment_checker")
